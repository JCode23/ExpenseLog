...
/**
 * Created by siddhant on 11/24/16.
 */
public class DBSalary extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "edit_account_salary.db";
    private static final int DATABASE_VERSION = 1;
    public static final String TABLE_NAME = "data_salary";
    public static final String COLUMN_ID = "_id";
    public static final String COLUMN_BALANCE = "balance";
    public static final String COLUMN_DESCRIPTION = "description";
    public static final String COLUMN_DATE = "date";

    public DBSalary(Context context) {
